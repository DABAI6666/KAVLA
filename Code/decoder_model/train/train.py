...
def preprocess_plain(
    ...
    conversations[0]["value"] = triple_prompt + conversations[0]["value"].strip()
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # 调用 preprocess_plain，并传入三元组信息
        data_dict = preprocess_plain(conversations, self.tokenizer, selected_triples)
